    ...
    <div className="bg-gradient-to-br from-slate-50 via-indigo-50 to-indigo-100  mx-auto p-4">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6 gap-2">
        ...
        <div className="text-sm text-gray-600">
          {completedCertificates.length} completed,{" "}
          {inProgressCertificates.length} in progress
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {completedCertificates.map((certificate) => (
              ...
              >
                ...
                <button
                  onClick={() =>
                    handleDownload(certificate.id, certificate.title)
                  }
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {inProgressCertificates.map((certificate) => (
              ...
              >
                ...
                <div className="bg-indigo-50 text-indigo-700 py-2 px-4 rounded-md text-center text-sm">
