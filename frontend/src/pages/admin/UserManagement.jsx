...
import { Users, Plus, Filter, Trash2, Search, UserCheck, Building, GraduationCap } from 'lucide-react';
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className={`p-3 rounded-xl ${
                    ...
                    user.role === 'mentor' ? 'bg-blue-100' :
                    user.role === 'recruiter' ? 'bg-green-100' :
                    'bg-gray-100'
                  }`}>
                    {user.role === 'mentor' ? <UserCheck size={20} className="text-blue-600" /> :
                     user.role === 'recruiter' ? <Building size={20} className="text-green-600" /> :
                ...
                {(user.department || user.company) && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-800 font-medium">
                      {user.role === 'recruiter' ? user.company : user.department}
