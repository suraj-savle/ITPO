...
import { Users, UserCheck, UserPlus, Clock, TrendingUp, Award, Building, BarChart3 } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-2xl font-semibold text-gray-900">{stats.totalStudents || 0}</span>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-2xl font-semibold text-gray-900">{stats.placedStudents || 0}</span>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-2xl font-semibold text-gray-900">{stats.totalMentors || 0}</span>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-2xl font-semibold text-gray-900">{stats.pendingApprovals || 0}</span>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-2xl font-semibold text-green-600">{stats.placedStudents || 0}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
              ...
              <span className="text-2xl font-semibold text-red-600">{stats.unplacedStudents || 0}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
              ...
              <span className="text-2xl font-semibold text-blue-600">{placementRate}%</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-2xl font-semibold text-purple-600">{stats.totalMentors || 0}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
              ...
              <span className="text-2xl font-semibold text-green-600">{stats.totalRecruiters || 0}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
              ...
              <span className="text-2xl font-semibold text-orange-600">{stats.pendingApprovals || 0}</span>
            </div>
          </div>
        </div>
      </div>
