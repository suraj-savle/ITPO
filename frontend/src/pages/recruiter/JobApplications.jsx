...
const JobApplications = () => {
  ...
  const getStatusBadge = (status) => {
    const config = {
      'pending recruiter review': { bg: 'bg-orange-100', text: 'text-orange-700', label: 'Pending Review' },
      'interview scheduled': { bg: 'bg-blue-100', text: 'text-blue-700', label: 'Interview Scheduled' },
      'hired': { bg: 'bg-green-100', text: 'text-green-700', label: 'Hired' },
      'rejected by recruiter': { bg: 'bg-red-100', text: 'text-red-700', label: 'Rejected' }
            ...
            <div key={app._id} className="bg-white rounded-xl border border-gray-100 p-6 hover:shadow-lg transition-all duration-200">
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-2">
                  <button 
                    onClick={() => window.open(`/recruiter/student/${app.student._id}`, '_blank')}
