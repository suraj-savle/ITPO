                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div className="bg-gradient-to-br from-indigo-50 to-indigo-50 rounded-xl p-3 text-center">
                  ...
                  <div>
                    ...
                    {application.job.skillsRequired &&
                      application.job.skillsRequired.length > 0 && (
                        <div className="mb-4">
                          <h5 className="text-sm font-semibold text-gray-700 mb-2">
                            Required Skills
                          </h5>
                          <div className="flex flex-wrap gap-2">
                            {application.job.skillsRequired.map(
                              (skill, index) => (
                                <span
                                  key={index}
                      ...
                      <div className="flex gap-3">
                        <button
                          onClick={() => {
                            ...
                            if (date)
                              handleDecision(application._id, "schedule", date);
                          }}
                          className="flex-1 bg-gradient-to-r from-indigo-600 to-indigo-600 text-white py-2 px-4 rounded-xl font-semibold hover:from-indigo-700 hover:to-indigo-700 transition-all duration-200 flex items-center justify-center gap-2"
                        >
                          <Calendar size={16} />
                          Schedule Interview
                        </button>
                        <button
                          onClick={() =>
                            handleDecision(application._id, "reject")
                          }
                    ...
                    {application.status === "interview scheduled" && (
                      <div className="flex gap-3">
                        <button
                          onClick={() =>
                            handleDecision(application._id, "hire")
                          }
