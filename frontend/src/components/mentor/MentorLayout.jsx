...
import { Bell, User, LogOut, Menu, X, Users, CheckCircle, BarChart3 } from 'lucide-react';

const MentorLayout = () => {
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [notifications] = useState([
    { id: 1, text: 'New application from John Doe needs approval', time: '1h ago' },
    { id: 2, text: 'Sarah Smith submitted feedback request', time: '3h ago' }
  ]);
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-blue-600">Campus Connect - Mentor</h1>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <span className="hidden sm:block text-sm font-medium whitespace-nowrap">Dr. Jane Smith</span>
            </div>
